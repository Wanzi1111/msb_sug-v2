  ...
  <div>
    ...
    >
      ...
      <div class="approvallk">
        ...
        <el-row>
          <el-col :span="4">转班类型:</el-col>
          <el-col :span="19" :offset="1">{{
            {
              CHANGE_1V1: '转1v1',
              CHANGE_XBK: '转小班课'
            }[drawerApprovalDeatail.changeType]
          }}</el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          <el-col :span="4">消课周数:</el-col>
          <el-col :span="19" :offset="1">{{
            drawerApprovalDeatail.periodRefund + '周'
          }}</el-col>
        </el-row>
        <el-row>
          <el-col :span="4">转班金额:</el-col>
          ...
          <el-col :span="13" :offset="1">
            <mark
              v-if="name === 'pending'"
              @click="changeCapital = true"
            >修改金额</mark>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="4">转班说明:</el-col>
          <el-col :span="19" :offset="1">{{
        ...
        <el-row v-if="name === '1'" style="margin-left: 40px">
  ...
  methods: {
    ...
    confirm_capital() {
      this.$refs.refundForm_capital.validate(async(valid) => {
        if (valid) {
          const { code } = await this.$http.Backend.changeCashConcept({
            flowApprovalId: this.forSonDataApprovalId,
