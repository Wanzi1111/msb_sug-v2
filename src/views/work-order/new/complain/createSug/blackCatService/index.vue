  ...
  <div>
    ...
    <div class="app-container">
      <basics-table
        ref="table"
        :table="table"
        :loading="loadings._k8s_api_complaint_api_v2_complaint_batchComplaintList || loadings._k8s_api_complaint_api_v2_complaint_exportBatchRecord"
        :list="list"
        :get-list="getList"
        :columns="columns"
        :total="total"
...
export default {
  ...
  methods: {
    addSug() {
      this.$router.push({ name: 'createService', params: { type: '4' }})
      // this.info.title = '创建投诉'
      // this.dialogVisible = true
      // this.sugForm = userForm
    ...
    jump() {
      this.$router.push({ name: 'batchImport', params: { type: '4' }})
    },
