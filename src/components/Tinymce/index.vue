...
const tinymceCDN = 'https://cdnvip.meishubao.com/vipboss/static/tinymce/tinymce.min.js'
...
export default {
  ...
  methods: {
    ...
    imageSuccessCBK(arr) {
      const _this = this
      arr.forEach(v => {
        window.tinymce.get(_this.tinymceId).insertContent(`<img width="100%" class="wscnph" src="${v.url}" >`)
      })
    }
  }
}
